...
![image-20220211120537405](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211120537405.png)
...
![image-20220211120559016](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211120559016.png) CNAME（意为：别名)：在域名解析中，实际上解析出来的指定域名对应的IP地址，或者该域名的一个CNAME，然后再根据这个CNAME来查找对应的IP地址。
...
**图示：** ![image-20220211120552486](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211120552486.png) **代码实现：**
