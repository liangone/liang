# 03.说说 linux系统下文件操作常用的命令有哪些？

![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928212832118)
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928212839715)
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928212845827)其实 `file2` 只是 `file1` 的一个快捷方式，它指向的是 `file1` ，所以显示的是 `file1` 的内容，但其实 `file2` 的 `inode` 与 `file1` 并不相同
