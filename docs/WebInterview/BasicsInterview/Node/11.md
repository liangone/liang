...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928160126900)

## 一、是什么

JWT（JSON Web Token），本质就是一个字符串书写规范，如下图，作用是用来在用户和服务器之间传递安全可靠的信息

![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928160130971)
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928160137526)
