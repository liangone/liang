...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928145840391)
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928145847460)

#### `webpack`的能力：

「编译代码能力」，提高效率，解决浏览器兼容问题![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928145853678)「模块整合能力」，提高性能，可维护性，解决浏览器频繁请求文件的问题![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928145900241)「万物皆可模块能力」，项目维护性增强，支持不同种类的前端模块类型，统一的模块化方案，所有资源文件的加载都可以通过代码控制![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928145905918)