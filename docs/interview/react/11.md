...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928203159515)

## 一、是什么

首先，给出`react`组件中进行列表渲染的一个示例：
...
跟`Vue`一样，`React` 也存在`diff`算法，而元素`key`属性的作用是用于判断元素是新创建的还是被移动的元素，从而减少不必要的`Diff`
...
![图片](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/640-20210928203206023)
