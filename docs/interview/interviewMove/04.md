...
![image-20220210114511951](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114511951.png) func1的运行结果其实就是一个Promise对象。因此也可以使用then来处理后续逻辑。
...
![img](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114456007.png)
