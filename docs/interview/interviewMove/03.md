# 「2022」高频前端面试题之JavaScript篇（上）

![image-20220210114110314](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114110314.png)
...
下面看一下**双精度数是如何保存**的： ![image-20220210114336789](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114336789.png)
...
其流程图如下： ![image-20220210114328400](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114328400.png)
...
最终，a、b、c分别被赋予了数组第0、1、2个索引位的值：
 ...
 ![image-20220210114310699](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114310699.png) 
...
通过把中间位留空，可以顺利地把数组第一位和最后一位的值赋给 a、c 两个变量： ![image-20220210114305508](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114305508.png)
...
这样就得到了 name 和 age 两个和 stu 平级的变量： ![img](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114257208.png)
...
遍历方法的详细解释：[《细数JavaScript中那些遍历和循环》](https://Fcuggz.blog.csdn.net/article/details/107649549)
...
**特点：** JavaScript 对象是通过引用来传递的，创建的每个新对象实体中并没有一份属于自己的原型副本。当修改原型时，与之相关的对象也会继承这一改变。 ![image-20220210114134304](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114134304.png)
...
由于`Object`是构造函数，原型链终点是`Object.prototype.__proto__`，而`Object.prototype.__proto__=== null // true`，所以，原型链的终点是`null`。原型链上的所有原型都是对象，所有的对象最终都是由`Object`构造的，而`Object.prototype`的下一级是`Object.prototype.__proto__`。 ![image-20220210114126473](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220210114126473.png)
