# 「2022」高频前端面试题之React篇（上）

![image-20220211105532518](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105532518.png)
...
不可以，render 阶段 DOM 还没有生成，无法获取 DOM。DOM 的获取需要在 pre-commit 阶段和 commit 阶段： ![image-20220211105608292](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105608292.png)
...
![image-20220211105621001](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105621001.png) 具体的执行过程如下（源码级解析)：
...
![image-20220211105635726](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105635726.png)
...
React常见的生命周期如下： ![image-20220211105653861](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105653861.png) **React常见生命周期的过程大致如下：**
...
**state 更新流程：** ![image-20220211105713992](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105713992.png) 这个过程当中涉及的函数：
...
**props 更新流程：** ![image-20220211105722119](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105722119.png) 相对于 state 更新，props 更新后唯一的区别是增加了对 componentWillReceiveProps 的调用。关于 componentWillReceiveProps，需要知道这些事情：
...
关于 React16 开始应用的新生命周期： ![image-20220211105731012](https://cdn.jsdelivr.net/gh/IceRain-mvc/cdn/img/image-20220211105731012.png) 可以看出，React16 自上而下地对生命周期做了另一种维度的解读：
